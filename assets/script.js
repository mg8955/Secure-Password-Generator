...
function generatePassword() {
  ...
  if (addUpp && addSpChar && !addLow && !addNum) {
    ...
    while (pwdOutput.length <= inputLength) {
      stringContainer.emptyString = stringContainer.upABC.concat(stringContainer.nums, stringContainer.loABC);
      console.log(stringContainer.emptyString);
      pwdOutput += stringContainer.emptyString[Math.floor(Math.random() * stringContainer.emptyString.length)];
    } 
    console.log(pwdOutput);
    ...
    while (pwdOutput.length <= inputLength) {
      stringContainer.emptyString = stringContainer.upABC.concat(stringContainer.nums, stringContainer.loABC, stringContainer.spChar);
      console.log(stringContainer.emptyString);
      pwdOutput += stringContainer.emptyString[Math.floor(Math.random() * stringContainer.emptyString.length)];
    } 
    console.log(pwdOutput);
    ...
    while (pwdOutput.length <= inputLength) {
      stringContainer.emptyString = stringContainer.loABC.concat(stringContainer.nums);
      console.log(stringContainer.emptyString);
      pwdOutput += stringContainer.emptyString[Math.floor(Math.random() * stringContainer.emptyString.length)];
    } 
    console.log(pwdOutput);
